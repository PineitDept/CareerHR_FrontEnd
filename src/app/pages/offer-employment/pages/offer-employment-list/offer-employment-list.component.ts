...
@Component({
  selector: 'app-offer-employment-list',
  templateUrl: './offer-employment-list.component.html',
  styleUrl: './offer-employment-list.component.scss'
})
export class OfferEmploymentListComponent {
