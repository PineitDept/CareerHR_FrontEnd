...
@Component({
  selector: 'app-interview-round-2',
  templateUrl: './interview-round-2.component.html',
  styleUrl: './interview-round-2.component.scss'
})
export class InterviewRound2Component {
  ...
  onFilterButtonClick(key: string) {
    switch (key) {
      case 'history':
        this.router.navigate(['/interview-scheduling/interview-round-2/history']);
        break;
    }
  }
  ...
  // แปลงค่าให้ <input type="datetime-local"> => yyyy-MM-ddTHH:mm
  ...
  // เปิด native picker (fallback el.click หากไม่รองรับ showPicker)
